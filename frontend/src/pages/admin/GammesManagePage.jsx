  ...
  return (
    <div className="p-4 md:p-6">
      <div className="flex flex-col gap-4 mb-6 md:mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-fuchsia-primary">Gestion des Gammes</h1>
        
        <div className="flex flex-col sm:flex-row gap-2 md:gap-3 flex-wrap">
          {/* Toggle Promo Globale */}
          <button
            onClick={() => handleGlobalPromo(true)}
            className="bg-green-500 text-white px-3 md:px-4 py-2 rounded-lg hover:bg-green-600 transition-colors text-xs md:text-sm font-medium whitespace-nowrap"
          ...
          <button
            ...
            className="bg-red-500 text-white px-3 md:px-4 py-2 rounded-lg hover:bg-red-600 transition-colors text-xs md:text-sm font-medium whitespace-nowrap"
          ...
          <button
            ...
            className="bg-fuchsia-primary text-white px-4 md:px-6 py-2 md:py-3 rounded-lg flex items-center justify-center gap-2 hover:bg-pink-700 transition-colors text-sm font-medium whitespace-nowrap"
          >
      ...
      {/* Info badge */}
      <div className={`mb-6 p-3 md:p-4 rounded-lg ${globalPromoActive ? 'bg-green-50 border border-green-200' : 'bg-gray-50 border border-gray-200'}`}>
          ...
          <table className="w-full min-w-[700px]">
            <thead className="bg-fuchsia-primary text-white">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-sm">Prix</th>
                <th className="px-4 py-3 text-center text-sm">Promo</th>
            ...
            <tbody>
              {gammes.map((gamme) => (
                <tr key={gamme._id} className="border-b hover:bg-gray-50">
                  <td className="px-4 py-3 font-medium text-sm">{gamme.name}</td>
                  <td className="px-4 py-3 text-sm">{gamme.category}</td>
                  <td className="px-4 py-3">
                    <div>
                      <span className={gamme.isPromoActive ? 'line-through text-gray-400 text-xs' : 'font-bold text-sm'}>
                ...
                <td className="px-4 py-3 text-center">
                  <span className={`px-2 py-1 rounded-full text-xs ${gamme.inStock ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
